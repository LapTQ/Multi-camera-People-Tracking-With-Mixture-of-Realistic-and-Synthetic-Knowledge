...
from layers.metric_learning_loss import Arcface, Cosface, AMSoftmax, CircleLoss
...
class build_transformer(nn.Module):
    ...
    def forward(
        self, x, label=None, cam_label=None
...
class build_transformer_local(nn.Module):
    def __init__(self, num_classes, camera_num, view_num, cfg, rearrange):
